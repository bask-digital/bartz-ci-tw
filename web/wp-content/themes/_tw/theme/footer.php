...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-slate-800">
  <div class="mx-auto max-w-screen-xl text-center">
      <a href="#" class="flex justify-center items-center text-2xl font-semibold text-slate-900 dark:text-white">
      ...
      <p class="my-6 text-slate-500 dark:text-slate-400">Open-source library of over 400+ web components and interactive elements built for better web.</p>
      <ul class="flex flex-wrap justify-center items-center mb-6 text-slate-900 dark:text-white">
          <li>
      ...
      <span class="text-sm text-slate-500 sm:text-center dark:text-slate-400">© 2021-2022 <a href="#" class="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
  </div>
</footer>
